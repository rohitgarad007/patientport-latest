        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select options={hospitals.map((h) => ({ value: String(h.hosuid), label: h.name }))} value={hospitals.map((h) => ({ value: String(h.hosuid), label: h.name })).find((h) => h.value === formData.hospitalId) || null} onChange={(opt) => handleChange("hospitalId", opt?.value || "")} placeholder="Select hospital..." isClearable />
