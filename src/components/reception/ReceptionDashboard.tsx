  ...
  return (
    <div className="min-h-screen bg-muted p-6">
      ...
      <div className="grid grid-cols-5 gap-4 mb-6">
        ...
        <StatsCard
          title="Average Wait"
          value={`${hospitalStats.avgWaitTime} min`}
          icon={Clock}
          variant="warning"
        />
        <StatsCard
        ...
        <StatsCard
          ...
          value={hospitalStats.doctorsAvailable}
          icon={Activity}
          variant="accent"
        />
      </div>
          ...
          <div className="bg-card rounded-2xl p-6 shadow-lg">
            <div className="flex items-center justify-between mb-6">
              ...
              <Badge variant="secondary">
                {currentPatients.length} in progress
              </Badge>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              {activeDoctors.slice(0, 3).map((doctor, index) => {
                const patient =
                  currentPatients[index] || patients[index + 2];
                ...
                return (
                  <div key={doctor.id} className="bg-muted rounded-xl p-5">
                    ...
                    <div className="bg-card rounded-lg p-3 text-center">
                      ...
                      <div className="token-number text-2xl font-bold text-token-active">
                        {patient?.tokenNumber ?? "-"}
                      </div>
