...
const ReceptionScreenDesign = () => {
  ...
  const renderScreen = () => {
    ...
    switch (layoutId) {
      ...
      case 5: return <Screen5MinimalWhite {...props} />;
      case 6: return <Screen6MultiCounter {...props} />;
      case 7: return <Screen7FullScreenToken {...props} />;
      case 8: return <Screen8TimelineView {...props} />;
      case 9: return <Screen9Dashboard {...props} />;
...
export default ReceptionScreenDesign;
