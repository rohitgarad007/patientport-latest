  ...
  const getDoctor = () => {
    if (data?.doctors && data.doctors.length > 0) {
      ...
      return {
        ...
        image: d.profile_image || doctors[3].image,
        room: d.room_number || "102",
        avgTime: d.avg_consultation_time ? parseInt(d.avg_consultation_time) : 12
      };
    }
    if (data?.activeConsultations && data.activeConsultations.length > 0) {
      ...
      return {
        name: d.doctor_name,
        specialty: d.specialization || "General",
        image: d.doctor_image || doctors[3].image,
        room: "102",
        avgTime: 12
      };
    }
