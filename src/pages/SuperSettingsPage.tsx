            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="system-name" defaultValue="HealthCare Pro" />
                </div>
                <div className="space-y-2">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="role" defaultValue={currentUser?.role.replace('_', ' ')} disabled />
                </div>
              </div>

              <div className="space-y-2">
                <Label htmlFor="address">Address</Label>
                <Textarea id="address" defaultValue={currentUser?.address} />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">2.4 GB / 10 GB used</p>
                </div>
                <div className="space-y-2">
                  <Label>Active Users</Label>
                  <p className="text-sm text-muted-foreground">127 online now</p>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">January 14, 2024 at 3:00 AM • 2.4 GB</p>
                    </div>
                    <div className="flex gap-2">
                      <Button variant="outline" size="sm">
                  ...
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">January 13, 2024 at 3:00 AM • 1.8 GB</p>
                    </div>
                    <div className="flex gap-2">
                      <Button variant="outline" size="sm">
                        <Download className="w-4 h-4 mr-2" />
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-700 mt-1">
                      Always test backup restoration in a safe environment before relying on backups for recovery.
                    </p>
                  </div>
                </div>
              </div>
