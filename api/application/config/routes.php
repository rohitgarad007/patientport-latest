...
$route['hospital/website_settings/update'] = 'HospitalProfileController/update_website_settings';
$route['hospital/website_settings/upload_banner'] = 'HospitalProfileController/upload_website_banner';
$route['hospital/website_settings/(:any)'] = 'HospitalProfileController/get_website_settings/$1';
$route['hospital/website_settings/banner/add'] = 'HospitalProfileController/add_website_banner';
$route['hospital/website_settings/banner/update'] = 'HospitalProfileController/update_website_banner';
$route['hospital/website_settings/banner/change_status'] = 'HospitalProfileController/change_website_banner_status';
$route['hospital/website_settings/template/update'] = 'HospitalProfileController/update_website_template';
$route['hospital/website_settings/about/update'] = 'HospitalProfileController/update_website_about';
...
$route['public_hospital_specializations']           = 'PublicHomeController/GetHospitalSpecializationsByHosuid';
$route['public_hospital_doctors']                   = 'PublicHomeController/GetHospitalDoctorsByHosuid';
$route['public_hospital_about']                     = 'PublicHomeController/GetHospitalAboutByHosuid';
$route['public_hospital_amenities']                 = 'PublicHomeController/GetHospitalAmenitiesByHosuid';
$route['public_hospital_banners']                   = 'PublicHomeController/GetHospitalBannersByHosuid';
...
$route['sf_staff_getLoggedInProfile']              = 'SFStaffController/getLoggedInStaffProfile';
$route['sf_staff_getTodaysAppointmentsGrouped']    = 'SFStaffController/getTodaysAppointmentsGrouped';
