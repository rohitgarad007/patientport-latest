...
class SAStaffController  extends CI_Controller {
    ...
    public function AddStaffInformation() {
        ...
        try {
            ...
            $requiredFields = ['name','email','phone','role','department', 'hospitalId'];
    ...
    public function UpdateStaffInformation() {
        ...
        try {
            ...
            $requiredFields = ['name','phone','role','department', 'hospitalId'];
            ...
            $update = $this->StaffCommonModel->updateStaffInformation($staffUid, $staffData);
    ...
    public function ManageStaffList() {
        ...
        try {
            ...
            $hospitalId = isset($rawData['hospitalId']) ? trim($rawData['hospitalId']) : '';

            $offset = ($page - 1) * $limit;

            // Total count
            $totalRows = $this->StaffCommonModel->get_StaffCount($search, $role, $hospitalId);

            // Doctor list
            $staffList = $this->StaffCommonModel->get_StaffList($search, $role, $hospitalId, $limit, $offset);
            $AES_KEY = "RohitGaradHos@173414";
    ...
    public function changeStaffStatus() {
        ...
        try {
            ...
            $update = $this->StaffCommonModel->updateStaffStatus($staffUid, $status);
    ...
    public function DeleteStaffInformation() {
        ...
        try {
            ...
            $update = $this->StaffCommonModel->updateStaffInformation($staffUid, $updateData);
